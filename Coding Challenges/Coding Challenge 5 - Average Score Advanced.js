...
/*=============================================================================================================================================*/
console.log(`Coding Challenge 5 - Average Score Advanced
-----------------------------------------------------
...
function checkWinner(avgDolphins, avgKoalas) {
    if (avgDolphins >= avgKoalas * 2) {
        console.log(`Team Dolphins win with average score of (${avgDolphins} vs ${avgKoalas})`);
    } else if (avgDolphins * 2 <= avgKoalas) {
        console.log(`Team Koalas win with average score of (${avgKoalas} vs ${avgDolphins})`);
    } else {
